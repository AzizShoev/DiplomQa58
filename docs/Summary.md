...
* Запланировано 20 тест-кейса
* Автоматизировано 22 тест-кейса (добавлены кейсы тестирования форм с пустыми полями)
...
* Со всеми рисками потрачено около 60 часов. Основное время потрачено на освоение инструментов, запуск SUT на разных СУБД и написание отчётов.